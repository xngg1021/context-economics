...
> 研究：2026-08-19，SJF × Hermes。方法：四路并行子代理全网调研（全部来源标注、未核实项如实声明）
...
| **0.12（已实装）** | **省 64.2%** | **省 44.0%** | 56 | 0.998 | 0.999 |
| 0.15 | 省 61.7% | 省 40.1% | 39 | 0.998 | 0.999 |
| 0.30 | 省 49.8% | 省 21.5% | 10 | 0.990 | 0.996 |
| 0.50（旧配置） | 省 36.1% | — | 4 | 0.986 | 0.994 |
...
THM 目标函数 λ 标定模块。要点：T0 热层驻留租金很小（default 2,322 tok/轮，命中下 $0.0007/轮），
